  ...
  <div class="login-container columnCC">
    ...
    <div class="login-pane">
      ...
      <el-form ref="refloginForm" class="login-form" :model="formInline" :rules="formRules">
        ...
        <el-form-item prop="managerId" :rules="formRules.isNotNull">
          <span class="svg-container">
            <ElSvgIcon name="User" :size="14" />
          </span>
          <el-input v-model="formInline.managerId" placeholder="用户名(admin)" />
          <!--占位-->
        </el-form-item>
        <el-form-item prop="managerPassword" :rules="formRules.isNotNull">
          <span class="svg-container">
          ...
          <el-input
            :key="passwordType"
            ref="refPassword"
            v-model="formInline.managerPassword"
            :type="passwordType"
            name="password"
